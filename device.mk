...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.sensor.dynamic_head_tracker.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.dynamic_head_tracker.xml \
